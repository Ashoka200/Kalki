...
const VERSION = 'kalki-v15';
const ASSETS = ['./', 'index.html', 'css/app.css', 'js/app.js', 'js/ui.js', 'js/brain.js',
  'js/skills.js', 'js/nlu.js', 'js/regions.js', 'js/personal.js', 'js/llm.js', 'js/web.js', 'js/venues.js', 'js/push.js', 'js/flights.js', 'js/hotels.js', 'js/theme.js', 'js/store.js', 'manifest.webmanifest',
